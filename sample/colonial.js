...
},
{
  ...
  "tables": {
    "default": [
      { "label": "Laborer",
        "subtable": "laborer", "print": false },
      { "label": "Criminal",
        "subtable": "criminal", "print": false },
      { "label": "Artisan",
        "subtable": "artisan", "print": false },
      { "label": "Professional",
        "subtable": "professional", "print": false }
    ],
    "laborer": [
      { "label": "Farmer" },
...

{
  ...
  "display_opt": {
	  ...
	  "men": { "hide_table": 1 },
	  "animals": { "hide_table": 1 },
	  "monsters": { "hide_table": 1 },
	  "other": { "hide_table": 1 },
	  "weather": { "hide_table": 1 }
  },
  "tables": {
    "default": [
