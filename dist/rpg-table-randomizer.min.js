...
"use strict";var _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(t){return typeof t}:function(t){return t&&"function"==typeof Symbol&&t.constructor===Symbol?"symbol":typeof t},isEmpty=function(t){return null===t||void 0===t||(Array.isArray(t)||isString(t)?0===t.length:0===Object.keys(t).length)},isString=function(t){return"[object String]"===toString.call(t)},isObject=function(t){var n="undefined"==typeof t?"undefined":_typeof(t);return"function"===n||"object"===n&&!!t},isUndefined=function(t){return void 0===t},capitalize=function(t){return t.charAt(0).toUpperCase()+t.slice(1)};module.exports={isEmpty:isEmpty,isString:isString,isObject:isObject,isUndefined:isUndefined,capitalize:capitalize};
},{}],4:[function(require,module,exports){
"use strict";var r_helpers=require("./r_helpers.js"),RandomName=function(e,a){var t=this;this.markov={},this.randomizer=e,this.namedata=a,this.generateList=function(e,a,t){var n={male:[],female:[]};"undefined"==typeof t&&(t=!1),"undefined"==typeof e&&(e=10),"undefined"!=typeof a&&""!==a||(a="random");for(var r=1;r<=e;r++){var i=r<=Math.ceil(e/2)?"male":"female";t&&"holmesian"!==a&&"demonic"!==a?n[i].push(this.createName(a,i,!0)):n[i].push(this.selectName(a,i))}return n},this.selectName=function(e,a,t){var n="";switch("undefined"!=typeof e&&""!==e&&"random"!==e||(e=this.randomizer.rollRandom(Object.keys(this.namedata.options))),"undefined"!=typeof a&&"random"!==a||(a=this.randomizer.rollRandom(["male","female"])),"undefined"!=typeof t&&"first"===t||(t=""),e){case"holmesian":n=this.holmesname();break;case"demonic":n=this.demonname();break;case"cornish":case"flemish":case"dutch":case"turkish":default:n=r_helpers.capitalize(this.randomizer.rollRandom(this.namedata[e][a])),"undefined"!=typeof this.namedata[e].surname&&"first"!==t&&(n+=r_helpers.capitalize(" "+this.randomizer.rollRandom(this.namedata[e].surname))),n=this.randomizer.findToken(n).trim()}return n},this.selectSurname=function(e){var a="";switch("undefined"!=typeof e&&""!==e&&"random"!==e||(e=this.randomizer.rollRandom(Object.keys(this.namedata.options))),e){case"holmesian":a=this.holmesname();break;case"cornish":case"flemish":case"dutch":case"turkish":default:a=r_helpers.capitalize(this.randomizer.rollRandom(this.namedata[e].surname)),a=this.randomizer.findToken(a)}return a},this.createName=function(e,a,t){var n=this;if("undefined"!=typeof e&&""!==e&&"random"!==e||(e=this.randomizer.rollRandom(Object.keys(this.namedata.options))),"undefined"==typeof t&&(t=!1),!this.namedata[e])return"";"undefined"==typeof a&&(a="");var r=e+"_"+a,i="",s="";if(this.markov.memory||(this.markov=new Markov({order:3})),!this.markov.memory[r]){var o=[];""===a?(o=this.namedata[e].male,o=o.concat(this.namedata[e].female)):o=this.namedata[e][a],o.forEach(function(e){n.markov.learn(r,e)})}return t&&!function(){var a=e+"_last";if(!n.markov.memory[a])if(n.namedata[e].surname){var t=n.namedata[e].surname;t.forEach(function(e){n.markov.learn(a,e)})}else n.markov.memory[a]={};i=n.capitalizeName(n.markov.generate(a))}(),s=this.capitalizeName(this.markov.generate(r)),""!==i&&(s+=" "+i),s},this.capitalizeName=function(e){var a=e.split(" "),t=a.map(function(e){return""+r_helpers.capitalize(e)});return t.join(" ")},this.holmesname=function(){for(var e="",a=this.randomizer.getWeightedRandom(this.namedata.holmesian_scount.values,this.namedata.holmesian_scount.weights),t=1;t<=a;t++)e+=this.randomizer.rollRandom(this.namedata.holmesian_syllables),t<a&&(e+=this.randomizer.getWeightedRandom([""," ","-"],[3,2,2]));return e=r_helpers.capitalize(e.toLowerCase()),e+=" "+this.randomizer.rollRandom(this.namedata.holmesian_title),e=this.randomizer.findToken(e),e=e.replace(/[\s\-]([a-z]{1})/g,function(e){return e.toUpperCase()})},this.demonname=function(){for(var e="",a=this.randomizer.getWeightedRandom([["first","last"],["first","inner","last"],["first","inner","inner","last"],["first","inner","inner","inner","last"]],[55,35,7,3]),t=0;t<a.length;t++)e+=this.randomizer.rollRandom(this.namedata.demonic[a[t]]);return e},this.registerNameType=function(e,a,t){return"undefined"!=typeof e&&""!==t&&("undefined"!=typeof t&&""!==t||(t=e),!!(a.male||a.female||a.surname)&&(this.namedata[e]=a,this.namedata.options[e]=t,!0))},this.randomizer.registerTokenType("name",function(e,a,n){console.log("name token");var r="",i=t;return"undefined"!=typeof e[1]&&""!==e[1]&&"random"!==e[1]||(e[1]=""),"undefined"!=typeof e[3]&&"first"===e[3]||(e[3]=""),"undefined"==typeof e[2]?r=i.selectSurname(e[1]):"male"===e[2]?r=i.selectName(e[1],"male",e[3]):"female"===e[2]?r=i.selectName(e[1],"female",e[3]):"random"===e[2]&&(r=i.selectName(e[1],"random",e[3])),r})},Markov=function(e){"undefined"==typeof e&&(e={}),this.memory={},this.separator=e.separator?e.separator:"",this.order=e.order?e.order:2,this.learn=function(e,a){var t=this.memory[e]?this.memory[e]:{};this.breakText(a,function(e,a){return t[e]||(t[e]=[]),t[e].push(a),t}),this.memory[e]=t},this.generate=function(e,a){return a||(a=this.genInitial()),this.cur_key=e,a.concat(this.step(a,[])).join(this.separator)},this.step=function(e,a){var t=this.memory[this.cur_key][e]||[""],n=this.getRandomValue(t);if(!n)return a;a.push(n);var r=e.slice(1);return r.push(n),this.step(r,a)},this.breakText=function(e,a){var t=e.split(this.separator),n=this.genInitial();t.forEach(function(e){e=e.toLowerCase(),a(n,e),n.shift(),n.push(e)}),a(n,"")},this.genInitial=function(){for(var e=[],a=0;a<this.order;e.push(""),a++);return e},this.getRandomValue=function(e){return e[Math.floor(Math.random()*e.length)]}};module.exports=RandomName;
},{"./r_helpers.js":3}],5:[function(require,module,exports){
"use strict";var r_helpers=require("./r_helpers.js"),RandomTable=function(e){this.id=0,this.key="",this.title="",this.author="",this.description="",this.source="",this.tags=[],this.sequence="",this.tables={},this.result=[];var t=function(e){for(var t in e)e.hasOwnProperty(t)&&(this[t]=e[t]);if(!r_helpers.isEmpty(this.table)){var i=this.tables;i.default=this.table,this.tables=i,delete this.table}""===this.key&&(this.key=this.id)};this.validate=function(e){var t={fields:[],general:""};return""===e.title&&(t.fields.push({field:"title",message:"Title cannot be blank"}),t.general+="Title cannot be blank. "),("string"==typeof e.tables||r_helpers.isEmpty(e.tables))&&(t.fields.push({field:"title",message:"Table cannot be empty"}),t.general+="Table cannot be empty. "),!(!r_helpers.isEmpty(t.fields)||!r_helpers.isEmpty(t.general))||t},this.niceString=function(e){"undefined"==typeof e&&(e=!1);var t=this.result;if(r_helpers.isString(t)||!Array.isArray(t)||0===t.length)return"";if(e)return t[0].result;var i="",r=this.print?this.print:{};return t.forEach(function(e){r[e.table]?(r[e.table].hide_table&&0!==r[e.table].hide_table||(i+=r_helpers.capitalize(e.table)+": "),r[e.table].hide_result&&0!==r[e.table].hide_result||(i+=r_helpers.capitalize(e.result)+"\n"),r[e.table].hide_desc&&0!==r[e.table].hide_desc||""!==e.desc&&(i+=e.desc+"\n")):(i+="default"===e.table?r_helpers.capitalize(e.result)+"\n":r_helpers.capitalize(e.table)+": "+r_helpers.capitalize(e.result)+"\n",""!==e.desc&&(i+=e.desc+"\n"))}),i=i.trim()},this.outputObject=function(e){"undefined"==typeof e&&(e=!1);var t=JSON.parse(JSON.stringify(this)),i=Object.keys(t);return i.forEach(function(i){!e&&r_helpers.isEmpty(t[i])&&delete t[i]}),t.result&&e?t.result=[]:t.result&&delete t.result,delete t.id,t},this.outputCode=function(e,t){"undefined"==typeof e&&(e=!1),"undefined"==typeof t&&(t=!1);var i=this.outputObject(e);return t?JSON.stringify(i):JSON.stringify(i,null,2)},this.findObject=function(e,t){"undefined"!=typeof t&&""!==t||(t="default");var i=this.tables[t];if(i[e])return i[e];if(Array.isArray(i)){var r=i.find(function(t){return t.label===e});return"undefined"!=typeof r?r:{}}return{}},this.findResultElem=function(e){"undefined"!=typeof e&&""!==e||(e="default");var t=this.result.find(function(t){return t.table===e});return"undefined"!=typeof t?t:{}},t.call(this,e)};module.exports=RandomTable;
},{"./r_helpers.js":3}],6:[function(require,module,exports){
"use strict";var _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol?"symbol":typeof e},r_helpers=require("./r_helpers.js"),Randomizer=function(){function e(e){for(var t=0,r=0;r<e.length;r++){var n=parseFloat(e[r]);isNaN(n)||(t+=n)}return t}function t(e,t,r,n){r="undefined"==typeof r?0:parseInt(r,10),e="undefined"==typeof e?6:parseInt(e,10),n="undefined"==typeof n?"+":n,t="undefined"==typeof t||0===t?1:parseInt(t,10);for(var i=0,o=1;o<=t;o++)i+=this.random(1,e);if(0===r)return i;switch(n){case"*":i*=r;break;case"-":i-=r;break;case"/":i/=r;break;case"+":default:i+=r}return Math.round(i)}function r(e,t){var r=e.replace("{{","").replace("}}","").split(":");return 0===r.length?e:this.token_types[r[0]]?this.token_types[r[0]](r,e,t):e}var n=this;this.token_types={},this.random=function(e,t){return null==t&&(t=e,e=0),e+Math.floor(Math.random()*(t-e+1))},this.getWeightedRandom=function(t,r){for(var n=0,i=this.random(1,e.call(this,r)),o=0;o<t.length&&(n+=r[o],!(n>=i));o++);return t[o]},this.rollRandom=function(e){var t=[],r=[];if(Array.isArray(e))e.forEach(function(e,n,i){"object"===("undefined"==typeof e?"undefined":_typeof(e))?("undefined"!=typeof e.weight?r.push(e.weight):r.push(1),t.push(e.label)):"string"==typeof e&&(r.push(1),t.push(e))});else if("object"===("undefined"==typeof e?"undefined":_typeof(e))&&null!==e){var n=Object.keys(e);n.forEach(function(n){var i=e[n];"undefined"!=typeof i.weight?r.push(i.weight):r.push(1),t.push(n)})}return this.getWeightedRandom(t,r)},this.getTableResult=function(e,t){var r=this;if(!r_helpers.isObject(e))return[{table:"Error",result:"No table found to roll on.",desc:""}];var n=[];"undefined"==typeof t&&(t="");var i=""===t?e.sequence:t;if("rollall"===i&&(i=Object.keys(e.tables)),""===i)if("undefined"!=typeof e.tables.default)n=this.selectFromTable(e,"default");else{var o=Object.keys(e.tables);n=this.selectFromTable(e,o[0])}else"string"==typeof i?n=this.selectFromTable(e,i):i.forEach(function(t){var i="";if(r_helpers.isString(t))return i=r.selectFromTable(e,t),void(n=n.concat(i));var o=t.table?t.table:"";if(""!==o)for(var s="number"==typeof t.times?t.times:1,l=1;l<=s;l++)i=r.selectFromTable(o),n=n.concat(i)});return e.result=n,n},this.selectFromTable=function(e,t){var r=this;if(!r_helpers.isObject(e))return[{table:"Error",result:"No table found to roll on.",desc:""}];if("undefined"==typeof t)return[{table:"Error",result:"No table found to roll on.",desc:""}];var n=[],i=e.tables[t],o=this.rollRandom(i),s="",l=!0;if(r_helpers.isUndefined(i[o])){if(s=i.find(function(e){return e.label===o}),r_helpers.isUndefined(s))return n.push({table:t,result:o,desc:""}),n;l="undefined"==typeof s.print||s.print}else s=i[o],l="undefined"==typeof i[o].print||i[o].print;if(l===!0){var f=r_helpers.isString(s.description)?s.description:"",a=this.findToken(o,e.key);n.push({table:t,result:a,desc:f})}var u=s.subtable,d="";if("undefined"==typeof u)return n;if(r_helpers.isString(u))d=this.selectFromTable(e,u),n=n.concat(d);else if(Array.isArray(u))u.forEach(function(t){d=r.selectFromTable(e,t),n=n.concat(d)});else if(r_helpers.isObject(u)){var p=Object.keys(u);p.forEach(function(t){var i=r.rollRandom(u[t]),o="";r_helpers.isUndefined(u[t][i])?(d=u[t].find(function(e){return e.label===i}),r_helpers.isObject(d)&&(o=r_helpers.isString(d.description)?d.description:"")):o=r_helpers.isString(u[t][i].description)?u[t][i].description:"",i=r.findToken(i,e.key),n.push({table:t,result:i,desc:o})})}return n},this.findToken=function(e,t){var n=this;"undefined"==typeof t&&(t="");var i=new RegExp("({{2}.+?}{2})","g"),o=e.replace(i,function(e){return r.call(n,e,t)});return o},this.roll=function(e){e="undefined"==typeof e?"":e.trim();var r=e.match(/^([0-9]*)d([0-9]+)(?:([\+\-\*\/])([0-9]+))*$/);return r?("undefined"==typeof r[4]&&(r[4]=0),""!==r[1]?t.call(this,parseInt(r[2],10),parseInt(r[1],10),parseInt(r[4],10),r[3]):t.call(this,parseInt(r[2],10),"1",parseInt(r[4],10),r[3])):""},this.setTableKeyLookup=function(e){this.getTableByKey=e},this.getTableByKey=function(e){return null},this.registerTokenType=function(e,t){this.token_types[e]=t},this.registerTokenType("roll",function(e,t,r){return n.roll(e[1])}),this.registerTokenType("table",function(e,t,r){var i="";if("undefined"==typeof e[1])return t;var o=1;if(e[1].indexOf("*")!==-1){var s=e[1].split("*");e[1]=s[0],o=s[1]}var l=null;if(l="this"===e[1]?n.getTableByKey(r):n.getTableByKey(e[1]),null===l||"object"!==("undefined"==typeof l?"undefined":_typeof(l)))return t;if("undefined"!=typeof e[2]&&e[2].indexOf("*")!==-1){var f=e[2].split("*");e[2]=f[0],o=f[1]}for(var a="undefined"==typeof e[2]?"":e[2],u=1;u<=o;u++)n.getTableResult(l,a),i+=l.niceString(!0)+", ";return i=i.trim(),i=i.replace(/,$/,"")})};module.exports=new Randomizer;
...
//# sourceMappingURL=dist/rpg-table-randomizer.js.map